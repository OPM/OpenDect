...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1211, 579)
        self.centralwidget = QtGui.QWidget(MainWindow)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.tabWidget = QtGui.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 341, 524))
        ...
        self.widget.setGeometry(QtCore.QRect(350, 20, 581, 501))
        self.widget.setObjectName(_fromUtf8("widget"))
        self.textEdit_2 = QtGui.QTextEdit(self.centralwidget)
        self.textEdit_2.setGeometry(QtCore.QRect(940, 20, 261, 491))
    ...
    def CreateGrid(self):
	    ...
	    self.GetValues()
    		...
    		for i in range(0,nblocks):
                ...
                #Plot the 3d plug
            maxporo=np.max(np.ma.masked_where(ACTNUM==1, PORO))
            minporo=np.min(np.ma.masked_where(ACTNUM==1, PORO))
